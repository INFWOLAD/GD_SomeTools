...
if __name__ == '__main__':
    ...
    PICS_ROOT = "D:\Tools\Program\Celeb-DF-v2-crop"   # The dir of cropped training faces
    train_csv = 'D:\Tools\Program\Celeb-DF-v2-crop\csv\dfgc_train.csv'  # the train split file
    val_csv = 'D:\Tools\Program\Celeb-DF-v2-crop\csv\dfgc_val.csv'      # the validation split file
